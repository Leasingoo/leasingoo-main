export const aboutPageSteps = [
  {
    title: "Vi listar er butik och leasingbilar",
    text: `
      Ni finns med på vår sökmotor där kunder hittar både era bilar och er butik.
    `,
  },
  {
    title: "Kunden väljer sin önskade bil",
    text: `
    När kunden hittat en bil som ni säljer så kan de skicka en intresseanmälan. `,
  },
  {
    title: "Vi skickar ut kunduppgifter",
    text: `
    Vi sammanställer ett dokument med kunduppgifter samt önskad bil att leasa.`,
  },
  {
    title: "Ni träffar kunden och skriver avtal",
    text: `
    Ni planerar in ett möte med kunden och går igenom leasingavtalet tillsammans.`,
  },
];
