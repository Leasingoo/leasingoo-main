...
import {
  aboutPageSteps,
  footerData,
} from "../helpers/static-data/aboutPrivatleasingPage";

const AboutPrivatleasing = () => {
    ...
    <Flex w="100%" flexDir="column" alignItems="center">
      ...
      <StaticTextContainer
        item={{
          ...
          direction: "row",
          image: "about-privatleasing-image2",
          bgColor: "#F3F4F6",
          mobileImage: "about-privatleasing-image2",
...
export default AboutPrivatleasing;
